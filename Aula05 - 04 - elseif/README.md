...
>não há limites em relação a aumentos de codições em ifs, porém deve ter cuidado com a quantidade pois fica a perguntas (não seria melhor um switch ?)
>
>porém quando utilizandos else if() se faz necessário fechar essa >cadeia com um else final, por questões de boas práticas
